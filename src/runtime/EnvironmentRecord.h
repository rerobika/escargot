...
public:
    ...
    virtual void bindThisValue(ExecutionState& state, Value thisValue)
    {
        ...
        if (m_thisBindingStatus == ThisBindingStatus::Initialized) {
            ErrorObject::throwBuiltinError(state, ErrorObject::Code::ReferenceError, errorMessage_InitializedThisBinding);
        }
    ...
    Value getThisBinding(ExecutionState& state)
    {
        ...
        if (m_thisBindingStatus == ThisBindingStatus::Uninitialized) {
            ErrorObject::throwBuiltinError(state, ErrorObject::Code::ReferenceError, errorMessage_UnInitializedThisBinding);
        }
