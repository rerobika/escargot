...
const char* errorMessage_InitializedThisBinding = "Initialized this binding status";
const char* errorMessage_UnInitializedThisBinding = "UnInitialized this binding status";
const char* errorMessage_NoSuperBinding = "No super binding";
