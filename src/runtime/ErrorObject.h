...
extern const char* errorMessage_InitializedThisBinding;
extern const char* errorMessage_UnInitializedThisBinding;
extern const char* errorMessage_NoSuperBinding;
